# Research landscape — first draft

Positions describe qualitative HW/SW/AI affinity, not measured percentages. Height uses discrete maturity stages: Idea, Experiment, PoC, Pilot, Operational. Height is not importance. Flagship is an independent editorial designation. This is a selected-project draft, not the complete organization inventory.
...
| RPC-H16 simulation | HW + SW | Experiment; discrete-event simulator | Calibrate optical assumptions |
| RPC-H16 physical concept | HW | Idea; no optical prototype | Small optical bench experiment |

## Roadmap priorities

Driftlab + Ontology merits deeper investigation. Circuit Breaker autonomy is a proposed research track: define ontology-grounded constraints, observe, shadow interventions, then evaluate bounded reversible actions. Compare against simple thresholds; measure false alarms, missed events and recovery. No autonomous intervention capability or maturity is asserted here.
